...
public class LoginActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextAmountConfirm = (TextView) findViewById(R.id.TextAmountConfirm);
        Intent receiveParams = getIntent();
        Bundle parametros = receiveParams.getExtras();

        DecimalFormat currency = new DecimalFormat("$###,###.##");


        int request_id = parametros.getInt("chave_request_id");
        double totalpay = parametros.getDouble("chave_totalpay");
        TextAmountConfirm.setText(String.valueOf(currency.format(totalpay)));
...
//                handler.sendEmptyMessage(0);
                    ...
                    PasswordAuthentication passAuth = PasswordAuthentication
                            ...
                            .createMerchantAuthentication("tharlleste27", "LiLEXXhP2727@", deviceID);
